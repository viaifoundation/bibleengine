...
{ //search
	...
	if(preg_match($pattern, $query))
	{
		...
		foreach($segments as $segment){
			...
			{
				$break=false;
				$book_names = array($book_chinese[$ii],$book_taiwan[$ii],$book_cn[$ii],$book_tw[$ii],$book_english[$ii],$book_english2[$ii],$book_en[$ii],$book_en2[$ii],$book_en3[$ii],$book_short[$ii]);
...
$title .= " -- Geshandi Bible Engine 歌珊地圣经引擎";
if($mode != 'QUERY')
