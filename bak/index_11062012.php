...
//		$text_cmp = $text_cmp .  "<a href=\"http://ccwiki.org/wiki/Bible:" . $osis . "\" target=_blank>(OSIS)</a>\n";
		...
		$option_url = "$wiki_base/Bible:" . $osis_cn;
...
function toggleOptions(elm,idx=0)
{

	var options = document.getElementById("options" + idx);
	if(elm.checked)
	{
		//alert("checked");
...
<p>&nbsp;</p>
<!--
  <p><?php echo $sitename?><a href="http://BibleEngine.com">BibleEngine.com</a>  <br/>
...
{
	global $query, $books, $script, $options, $multi_verse;
	global $cn, $tw, $en, $strongs;
	global $cuvs, $cuvt, $cuvc, $kjv, $nasb, $ckjvs, $ckjvt, $pinyin, $ncvs, $lcvs, $ccsb, $ukjv, $kjv1611, $bbe;
...
<input type='checkbox' name='o' id='o' value='o' <?php if($options) echo 'checked'?> onChange="javascript:toggleOptions(this,<?php echo $seq?>)">选项 Options
<a href="help.php"> 帮助 Help</a> 
<br/>(<small><a href="copyright.php">圣经译本版权信息 Bible Translation Copyright Information</a></small>)
