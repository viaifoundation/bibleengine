	...
	if($chapter)
	{
		...
		if($verse)
			if($verse2)
				...
				$sql = $sql . " AND bible_books.verse >= $verse - $extend AND bible_books.verse <=$verse + $extend";
...
<select name="r">
<option value=0 <?php if(!$range) echo "SELECTED";?>>整本圣经 Whole Bible</option>
<option value="1-39" <?php if($range=="1-39") echo "SELECTED";?>>旧约全书 Old Testament</option>
<option value="40-66" <?php if($range=="40-66") echo "SELECTED";?>>新约全书 New Testament</option>
<option value="1-5" <?php if($range=="1-5") echo "SELECTED";?>>摩西五经 Law (Gen - Deut)</option>
<option value="6-17" <?php if($range=="6-17") echo "SELECTED";?>>历史书 History (Josh - Esth)</option>
<option value="18-22" <?php if($range=="18-22") echo "SELECTED";?>>诗歌智慧书 Poetry & Wisdom (Job - Song)</option>
<option value="23-27" <?php if($range=="23-27") echo "SELECTED";?>>大先知书 Major Prophets (Is - Dan)</option>
<option value="28-39" <?php if($range=="28-39") echo "SELECTED";?>>小先知书 Minor Prophets (Hos - Mal)</option>
<option value="40-44" <?php if($range=="40-44") echo "SELECTED";?>>福音历史书 Gospels (Matt - Acts)</option>
<option value="45-57" <?php if($range=="45-57") echo "SELECTED";?>>保罗书信 Paul&#39;s Epistles (Rom - Philem)</option>
<option value="58-66" <?php if($range=="58-66") echo "SELECTED";?>>一般使徒书信 General Epistles (Heb - Rev)</option>
<option value=1 <?php if($range=="1") echo "SELECTED";?>>创世记 Genesis</option> 
<option value=2 <?php if($range=="2") echo "SELECTED";?>>出埃及记 Exodus</option> 
<option value=3 <?php if($range=="3") echo "SELECTED";?>>利未记 Leviticus</option> 
<option value=4 <?php if($range=="4") echo "SELECTED";?>>民数记 Numbers</option> 
<option value=5 <?php if($range=="5") echo "SELECTED";?>>申命记 Deuteronomy</option> 
<option value=6 <?php if($range=="6") echo "SELECTED";?>>约书亚记 Joshua</option> 
<option value=7 <?php if($range=="7") echo "SELECTED";?>>士师记 Judges</option> 
<option value=8 <?php if($range=="8") echo "SELECTED";?>>路得记 Ruth</option> 
<option value=9 <?php if($range=="9") echo "SELECTED";?>>撒母耳记上 1 Samuel</option> 
<option value=10 <?php if($range=="10") echo "SELECTED";?>>撒母耳记下 2 Samuel</option> 
<option value=11 <?php if($range=="11") echo "SELECTED";?>>列王记上 1 Kings</option> 
<option value=12 <?php if($range=="12") echo "SELECTED";?>>列王记下 2 Kings</option> 
<option value=13 <?php if($range=="13") echo "SELECTED";?>>历代志上 1 Chronicles</option> 
<option value=14 <?php if($range=="14") echo "SELECTED";?>>历代志下 2 Chronicles</option> 
<option value=15 <?php if($range=="15") echo "SELECTED";?>>以斯拉记 Ezra</option> 
<option value=16 <?php if($range=="16") echo "SELECTED";?>>尼希米记 Nehemiah</option> 
<option value=17 <?php if($range=="17") echo "SELECTED";?>>以斯帖记 Esther</option> 
<option value=18 <?php if($range=="18") echo "SELECTED";?>>约伯记 Job</option> 
<option value=19 <?php if($range=="19") echo "SELECTED";?>>诗篇 Psalms</option> 
<option value=20 <?php if($range=="20") echo "SELECTED";?>>箴言 Proverbs</option> 
<option value=21 <?php if($range=="21") echo "SELECTED";?>>传道书 Ecclesiastes</option> 
<option value=22 <?php if($range=="22") echo "SELECTED";?>>雅歌 Song of Solomon</option> 
<option value=23 <?php if($range=="23") echo "SELECTED";?>>以赛亚书 Isaiah</option> 
<option value=24 <?php if($range=="24") echo "SELECTED";?>>耶利米书 Jeremiah</option> 
<option value=25 <?php if($range=="25") echo "SELECTED";?>>耶利米哀歌 Lamentations</option> 
<option value=26 <?php if($range=="26") echo "SELECTED";?>>以西结书 Ezekiel</option> 
<option value=27 <?php if($range=="27") echo "SELECTED";?>>但以理书 Daniel</option> 
<option value=28 <?php if($range=="28") echo "SELECTED";?>>何西阿书 Hosea</option> 
<option value=29 <?php if($range=="29") echo "SELECTED";?>>约珥书 Joel</option> 
<option value=30 <?php if($range=="30") echo "SELECTED";?>>阿摩司书 Amos</option> 
<option value=31 <?php if($range=="31") echo "SELECTED";?>>俄巴底亚书 Obadiah</option> 
<option value=32 <?php if($range=="32") echo "SELECTED";?>>约拿书 Jonah</option> 
<option value=33 <?php if($range=="33") echo "SELECTED";?>>弥迦书 Micah</option> 
<option value=34 <?php if($range=="34") echo "SELECTED";?>>那鸿书 Nahum</option> 
<option value=35 <?php if($range=="35") echo "SELECTED";?>>哈巴谷书 Habakkuk</option> 
<option value=36 <?php if($range=="36") echo "SELECTED";?>>西番雅书 Zephaniah</option> 
<option value=37 <?php if($range=="37") echo "SELECTED";?>>哈该书 Haggai</option> 
<option value=38 <?php if($range=="38") echo "SELECTED";?>>撒迦利亚书 Zechariah</option> 
<option value=39 <?php if($range=="39") echo "SELECTED";?>>玛拉基书 Malachi</option> 
<option value=40 <?php if($range=="40") echo "SELECTED";?>>马太福音 Matthew</option> 
<option value=41 <?php if($range=="41") echo "SELECTED";?>>马可福音 Mark</option> 
<option value=42 <?php if($range=="42") echo "SELECTED";?>>路加福音 Luke</option> 
<option value=43 <?php if($range=="43") echo "SELECTED";?>>约翰福音 John</option> 
<option value=44 <?php if($range=="44") echo "SELECTED";?>>使徒行传 Acts</option> 
<option value=45 <?php if($range=="45") echo "SELECTED";?>>罗马书 Romans</option> 
<option value=46 <?php if($range=="46") echo "SELECTED";?>>哥林多前书 1 Corinthians</option> 
<option value=47 <?php if($range=="47") echo "SELECTED";?>>哥林多后书 2 Corinthians</option> 
<option value=48 <?php if($range=="48") echo "SELECTED";?>>加拉太书 Galatians</option> 
<option value=49 <?php if($range=="49") echo "SELECTED";?>>以弗所书 Ephesians</option> 
<option value=50 <?php if($range=="50") echo "SELECTED";?>>腓立比书 Philippians</option> 
<option value=51 <?php if($range=="51") echo "SELECTED";?>>歌罗西书 Colossians</option> 
<option value=52 <?php if($range=="52") echo "SELECTED";?>>帖撒罗尼迦前书 1 Thessalonians</option> 
<option value=53 <?php if($range=="53") echo "SELECTED";?>>帖撒罗尼迦后书 2 Thessalonians</option> 
<option value=54 <?php if($range=="54") echo "SELECTED";?>>提摩太前书 1 Timothy</option> 
<option value=55 <?php if($range=="55") echo "SELECTED";?>>提摩太后书 2 Timothy</option> 
<option value=56 <?php if($range=="56") echo "SELECTED";?>>提多书 Titus</option> 
<option value=57 <?php if($range=="57") echo "SELECTED";?>>腓利门书 Philemon</option> 
<option value=58 <?php if($range=="58") echo "SELECTED";?>>希伯来书 Hebrews</option> 
<option value=59 <?php if($range=="59") echo "SELECTED";?>>雅各书 James</option> 
<option value=60 <?php if($range=="60") echo "SELECTED";?>>彼得前书 1 Peter</option> 
<option value=61 <?php if($range=="61") echo "SELECTED";?>>彼得后书 2 Peter</option> 
<option value=62 <?php if($range=="62") echo "SELECTED";?>>约翰壹书 1 John</option> 
<option value=63 <?php if($range=="63") echo "SELECTED";?>>约翰贰书 2 John</option> 
<option value=64 <?php if($range=="64") echo "SELECTED";?>>约翰叁书 3 John</option> 
<option value=65 <?php if($range=="65") echo "SELECTED";?>>犹大书 Jude</option> 
<option value=66 <?php if($range=="66") echo "SELECTED";?>>启示录 Revelation</option> 
</select> 
