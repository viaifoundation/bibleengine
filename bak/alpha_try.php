...
{	
	...
	if(!$index)
	{
		...
		$text_kjv = $txt_nasb . "<b>" . $book_english[$book] . " (" . $book_en[$book] . ") " . $chapter . "</b>\n";
		$text_nasb = $txt_nasb . "<b>" . $book_english[$book] . " (" . $book_en[$book] . ") " . $chapter . "</b>\n";
	...
	//foreach($result as $row){
		...
		$txt_cn = $row['txt_cn'];
		$txt_en = $row['txt_en'];
		$txt_kjv = $row['text_kjv'];		
		$txt_nasb = $row['text_nasb'];
		foreach ($queries as $query_word){
			...
			*/
			...
			$txt_kjv= str_ireplace($query_word, "<strong>" . $query_word . "</strong>", $txt_kjv);			
			$txt_nasb= str_ireplace($query_word, "<strong>" . $query_word . "</strong>", $txt_nasb);
		}
		//$txt_py = $row['txt_py'];
		if($vid == $verse && ($mode=='READ' || $mode=='INDEX'))
		{
			...
			$txt_kjv = "<strong>" . $txt_kjv . "</strong>";
			$txt_nasb = "<strong>" . $txt_nasb . "</strong>";
...
//		$book_short = $row['short'];
		...
		*/
		...
		$text_kjv = $text_kjv . " <sup><a href=\"$short_url_base/" . $osis . ".htm\">" . $book_short[$bid] . " " . $cid . ":" . $vid . "</a></sup> " .  $txt_kjv . "\n";
		$text_nasb = $text_nasb . " <sup><a href=\"$short_url_base/" . $osis . ".htm\">" . $book_short[$bid] . " " . $cid . ":" . $vid . "</a></sup> " .  $txt_nasb . "\n";
...
*/		
		...
		$text_cmp = $text_cmp .  $txt_nasb . " (NASB)";		
		$text_cmp = $text_cmp .  "</p>\n";		
		}
		$text_cmp .= "<ul>\n";
		foreach ($bible_books as $bible_book) {
...
//		$text_cmp = $text_cmp .  "<a href=\"http://ccwiki.org/wiki/Bible:" . $osis . "\" target=_blank>(OSIS)</a>\n";
		...
		$option_url = "$BibleEngine_base//wiki/Bible:" . $osis_cn;
		...
		$option_url = "$BibleEngine_base//wiki/MHC:" . $book_chinese[$bid] . " " . $cid;
		...
		$option_url = "$BibleEngine_base//wiki/MHCC:" . $book_chinese[$bid] . " " . $cid;
	...
	$text_kjv = "<p>" . $text_kjv . " (King James Version, KJV) </p>";
	$text_nasb = "<p>" . $text_nasb . " (New American Standard Bible, NASB) </p>";
...
<p>&nbsp;</p>
  ...
  <a href="http://bible.geshandi.com">bible.geshandi.com</a> <a href="http://shengjing.geshandi.com">shengjing.geshandi.com</a>   <a href="http://bible.ymnl.org">bible.ymnl.org</a>   <a href="http://godwithus.cn/bible">godwithus.cn/bible</a>     <br>
  <a href="http://b.geshandi.com">b.geshandi.com</a> <a href="http://sj.geshandi.com">sj.geshandi.com</a> <a href="http://b.ymnl.org">b.ymnl.org</a>
...
<input  type="submit" value="查经 QUERY"> 
