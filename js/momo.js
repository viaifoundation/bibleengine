...
momo.config = {
	...
	'<img align="absmiddle" src="http://zhsw.org/bk/style/aoyun/logo.gif"/>圣网百科' +
	'</span>' +
	'<span style="float: right; margin-right: 5px">' +
	'<span style="cursor:pointer" onclick="momo.setOff()" title="禁用操作仅当前页面有效">禁用</span> '+
	'<img style="cursor:pointer" border="0" src="http://zhsw.org/bk/style/aoyun/guanbi_normal.gif" onclick = "momo.div.undisplay();"/>' +
	'</span>' +
	'</p>' +
...
momo.mouse = {
	...
	up: function(ev){
		...
		if(momo.mouse.flag){
			...
			//added by using ctrl+drag Michael HUO 11/21/2012
