					...
					if(!$reference2)
					{
						...
						{ 
								...
								if((int)$verses_temp[0])
								{
									...
									$sql_where .= " AND (verse BETWEEN (" . (int)$verses_temp[0] .  " -$multi_verse ) AND ("  . (int)$verses_temp[0] . " + $multi_verse  )";
									$index_temp=count($verses_temp);
									for($iii=1;$iii<$index_temp;$iii++)
									{
										//$sql_where .= " OR (verse=" . (int)$verses_temp[$iii] . ") ";
										$sql_where .= " OR verse BETWEEN (" . (int)$verses_temp[$iii] . " - $multi_verse ) AND ("  . (int)$verses_temp[$iii] . " + $multi_verse ) ";
									}
									$sql_where .= ") ";
								}
								else
