...
$long_url_base="http://bible.bible.world/$script";
$godwithus_base="http://bible.world";
$max_book_count = 7;
...
if($index)
{
	...
	if($chapter)
	{
		...
		if($verse)
			if($verse2)
				$sql = $sql . " AND bible_books.verse BETWEEN  $verse - $extend AND $verse2 + $extend";
			else
				$sql = $sql . " AND bible_books.verse BETWEEN $verse  - $extend AND $verse + $extend";
...
<p>&nbsp;</p>
  <p>神同在圣经 Godwithus Bible <a href="http://bible.bible.world">http://bible.bible.world</a> <a href="http://ccbible.me">http://ccbible.me</a> 我的华人基督徒圣经 Chinese Christian Bible for Me. 
</p>
...
<a href="http://bible.world/wiki/神同在圣经"> 帮助 Help</a> (<a href="devel.php">Devel</a> <a href="alpha.php">Alpha</a> <a href="beta.php">Beta</a> <a href="legacy.php">Legacy</a>)
...
<br/>(<small><a href="http://bible.world/wiki/圣经版权">圣经译本版权信息 Bible Translation Copyright Information</a></small>)
</div>
</FORM> 
